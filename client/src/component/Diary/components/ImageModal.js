...
class ImageModal extends Component {
    ...
    componentDidUpdate(prevProps) {
        if (this.props.upload.upload !== null && prevProps.upload !== this.props.upload) {
            this.setState({
    ...
    loader = () => {
        ...
        if (isUploading) {
            return (
                <div className="spinner-border text-info" role="status" style={{ marginRight: '1rem', verticalAlign: 'bottom ' }}>
            ...
            return (
                <img src="https://image.flaticon.com/icons/svg/179/179372.svg" style={{ width: "24px", margin: "3px", marginRight: "6px" }} />
            );
        }
        else {
            return null;
            ...
            <div style={{ display: 'inline' }}>
                ...
                >
                    ...
                    <ModalBody>
                        ...
                        >
                            <Typography component="div" style={{ padding: 6 * 3, marginTop: '15px', alignItems: 'center' }}>
                                <Form >
                                    <FormGroup>
                            ...
                            <Typography component="div" style={{ padding: 6 * 3, marginTop: '15px' }}>
                                <Form>
                                    <FormGroup>
                                        ...
                                        <Input
                                            ...
                                            id="upload"
                                        />
                                        <div id="upload-btn" style={{ float: 'right', marginTop: '0px' }}>
                                            {this.loader()}
                        ...
                        <Button color="dark" style={{ marginTop: '1rem' }} block onClick={this.onSubmit}>
                            Add Image
                        </Button>
                    </ModalBody>
                </Modal>
...
export default connect(mapStateToProps, { addImage, uploadImage, clearUpload })(ImageModal);
